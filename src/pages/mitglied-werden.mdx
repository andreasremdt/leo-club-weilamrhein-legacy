...
<CloudinaryImage
  name="sommercamp-in-huttwil.jpg"
  category="allgemein"
  width={800}
  height={500}
  objectFit="cover"
  alt="Leo-Aktion in Huttwil"
  lazy={false}
/>
...
Willst du am liebsten gleich Leo werden? Sende uns eine Nachricht und wir werden uns bei dir melden! Willst du Leo werden, bist aber zu weit von uns entfernt? In Deutschland gibt es hunderte [andere gleichartige Clubs](https://www.leo-clubs.de/), vielleicht ist ja einer in deiner Nähe?
